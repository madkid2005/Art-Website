...
import bgSeller from "../assets/images/sellerlogin.png";
import "./Signup.css"
export default function Signup() {
  ...
  return (
    <div className="bg-imgseller container-fluid d-flex align-items-center justify-content-center" style={{ height: "90vh", direction: "rtl" }}>
